...
import time
import urllib.request # comment this line if you don't need ThinkSpeak connection
...
#THINGSPEAK      = 'L3DZMAABAYKEL2VJ' # or type 'YOURAPIKEY'
THINGSPEAK      =  False
...
while(1):
       ...
       # print ('STATUS: ', bin(statusbyte))
        ...
        ret = client.publish('data',stringified_json_object)
        time.sleep(30.)
